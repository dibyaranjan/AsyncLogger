...
import com.github.dibyaranjan.asynclogger.logger.FileLogger;
...
public class ApplicationBeans {
    ...
    public HttpServer getHttpServer() {
        ...
        try {
            ...
            server.createContext("/log", getSimpleRequestHandler());
    ...
    @Bean
    public SimpleRequestHandler getSimpleRequestHandler() {
        SimpleRequestHandler simpleRequestHandler = new SimpleRequestHandler();
        simpleRequestHandler.setAsyncLogger(getFileLogger());
